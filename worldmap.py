...
foreign = ['中国','韩国','日本','伊朗','意大利','法国','美国','比利时','德国','荷兰','瑞典','西班牙','英国','希腊','瑞士','加拿大','菲律宾','新加坡','澳大利亚','马来西亚']
...
def worlddata():
    ...
    for csv in fileList:
        ...
        endDay = day + datetime.timedelta(days = 7)
        ...
        if name_ch in foreign:
            ...
            jsonData[name_en] = {
                ...
                "predict": {
                    ...
                    "value": [int(i) for i in predict]
                },
                "remain": {
                    "value": [int(i) for i in remain],
                }
            }
